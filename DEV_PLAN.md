...
**Still open:** the round-by-round history log (Phase 8 deferred), PWA + landing page (Phase 10/10a — the landing page should import the same `helpContent.tsx` blocks), accessibility/device pass (11), quality gate (12), deploy (13). Turing also still owes Holmes the EndGameScreen FIX 4 re-review.
